...
const thArray = ["number","title","Address","description","Last Name"];
const tdArray = [
    [ "1" , "Dakota Rice" , "home, 738" , "Oud-Turnhout" ] ,
    [ "2" , "Minerva Hooper" , "forest ,789" ,  "Sinaai-Waas" ] ,
    [ "3" , "Sage Rodriguez" , "forest ,142" ,  "Baileux" ] ,
    [ "4" , "Philip Chaney" , "city, 735" ,  "Overland Park" ] ,
    [ "5" , "Doris Greene" , "forest ,542" , "Feldkirchen in Kärnten" ] ,
    [ "6" , "Mason Porter" , "home, 615" ,  "Gloucester" ]
];
...
var legendPie = {
    names: ["Request","Incident","Complaint"],
...
var dataBar = {
  ...
  series: [
    ...
    [402, 203, 220, 520, 423, 303, 350, 334, 338, 430, 536, 495]
  ]
};
var optionsBar = {
